...
(function() {
  ...
  Webcaster.Model.Microphone = (function(superClass) {
    ...
    Microphone.prototype.addEvent = function(event) {
      this.events.events.push(this.events.timeString + " " + event);
      this.events.trigger("eventsChange");
      return console.log(this.events.events);
    };
  ...
  Webcaster.Model.Playlist = (function(superClass) {
    ...
    Playlist.prototype.addEvent = function(event) {
      this.events.events.push(this.events.timeString + " " + event);
      this.events.trigger("eventsChange");
      return console.log(this.events.events);
    };
  ...
  Webcaster.Model.Settings = (function(superClass) {
    ...
    Settings.prototype.initialize = function(attributes, options) {
      ...
      return this.events.on("eventsChange", (function(_this) {
        return function() {
          return _this.set({
            events: _.clone(_this.events.events)
          });
        };
      })(this));
    };

    Settings.prototype.setEventsState = function() {
      return this.events.started = true;
    };
  ...
  Webcaster.View.Microphone = (function(superClass) {
    ...
    Microphone.prototype.onRecord = function(e) {
      ...
      if (this.model.isPlaying()) {
        this.model.addEvent(this.$("#speaker-buttons .active").val() + "-stop");
        return this.model.stop();
      }
      this.model.addEvent(this.$("#speaker-buttons .active").val() + "-start");
    ...
    Playlist.prototype.initialize = function() {
      ...
      this.model.on("playing", (function(_this) {
        return function() {
          ...
          f = _this.model.get("files");
          title = f[_this.model.get("fileIndex")].metadata.title;
          artist = f[_this.model.get("fileIndex")].metadata.artist;
          _this.model.addEvent(artist + " - " + title + " start");
  ...
  Webcaster.View.Settings = (function(superClass) {
    ...
    Settings.prototype.initialize = function(arg) {
      ...
      return this.model.on("change:events", (function(_this) {
        return function() {
          _this.$("#eventslist").empty();
          _this.$("#eventslist").append("<ul>");
          _.each(_this.model.get("events"), function(event) {
            return _this.$("#eventslist").append("<li>" + event + "</li>");
          });
          return _this.$("#eventslist").append("</ul>");
        };
      })(this));
    };
  ...
  Webcaster.Model.Events = (function(superClass) {
    ...
    Events.prototype.initialize = function(attributes, options) {
      this.events = [];
      this.on("change:events", (function(_this) {
        return function() {
          return console.log("events changed");
        };
      })(this));
      this.started = false;
      this.seconds = 0;
      return this.timeString = "00:00:00";
    };
  ...
  Webcaster.View.Watch = (function(superClass) {
    ...
    Watch.prototype.initialize = function() {
      this.render();
      return this.clockInterval = this.updateWatch();
    };

    Watch.prototype.updateWatch = function() {
      var self;
      self = this;
    ...
    Watch.prototype.render = function() {
      this.$("h3.timer").html(this.model.timeString);
      return this;
    };
